...
# ANSWER: 
puts "The final line of code evaluated to True because the code asks if both statements are
true. The variable loves_to_play was given a value of true and dogs are considered in the puppy phas 
until 2 years old since both of these statements are true the full line of code it true."
